...
public class VerifyDimensionBox_1 {

	TestBase testBase = new TestBase();

	@Test
	public void verifyDimensionBox_1() throws InterruptedException {

		WebDriver driver = testBase.getDriver("CHROME");
		driver.manage().window().fullscreen();
		driver.get("http://cdn.adpushup.com/qaTakeHomeTask/");

		Dimension box1 = driver.findElement(By.xpath(XPathRepository.Box1)).getSize();
