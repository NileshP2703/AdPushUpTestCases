...
public class RefreshmentCheckAt30SecBox2 {

	TestBase testBase = new TestBase();

	@Test
	public void refreshmentCheckAt30SecBox2() throws InterruptedException {
		...
		for (int number = 2; number <= 5; number++) {
			...
			System.out.println("Box2 has been verified after 30 second " + number);
