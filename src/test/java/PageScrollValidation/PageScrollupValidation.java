...
public class PageScrollupValidation {

	TestBase testBase = new TestBase();

	@Test
	public void pageScrollupValidation() throws InterruptedException {
		...
		WebElement l = driver.findElement(By.xpath(XPathRepository.Box2));
		String strn = l.getText();
		System.out.println("Text obtained by scrolling down is :" + strn);
		Thread.sleep(1500);
		at.sendKeys(Keys.PAGE_UP).build().perform();

		WebElement m = driver.findElement(By.xpath(XPathRepository.Box1));
		String s = m.getText();
